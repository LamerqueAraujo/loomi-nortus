...
export default function LoginPage() {
  return (
    <main className="min-h-screen w-full bg-[var(--bg-auth)] text-[#E3E3E3] flex items-center justify-center px-6 lg:px-12 py-10">
        ...
        <section className="relative flex w-full lg:justify-end">
          ...
          <div
            className="
              ...
              p-8 h-full min-h-[400px] lg:min-h-[800px] shadow-neon-lg
            "
          />
        </section>
      </div>
